...
plot_hm_signatures(these_predictions = sjodahl_predicted, 
                   ...
                   gene_id = "hgnc_symbol", 
                   title = "Sjodahl 2017 - Classifications")
```

```{r figure 1, echo = FALSE, out.width = '100%', dpi = 300}
knitr::include_graphics("../man/figures/Sjodahl 2017 - Classifications_heatmap_scores.png")
```
...
plot_hm_scores(these_predictions = sjodahl_predicted,
               ...
               out_format = "png",
               out_path = "../man/figures/",
               title = "Sjodahl 2017 - Signature Scores")
```

```{r figure 2, echo = FALSE, out.width = '100%', dpi = 300}
knitr::include_graphics("../man/figures/Sjodahl 2017 - Signature Scores_heatmap_scores.png")
```
...
plot_ranked_score(these_predictions = sjodahl_predicted, 
                  ...
                  plot_title = "Sjodahl 2017 - Proliferation Score")
```
